                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex items-center gap-3 ml-auto">
                            ...
                            <div class="px-3 py-1.5 rounded-full text-xs font-semibold"
                                 :class="{
                                     'bg-red-50 text-red-800': $page.props.auth.user.role === 'admin',
                                     'bg-blue-50 text-blue-800': $page.props.auth.user.role === 'doctor',
                                     'bg-green-50 text-green-800': $page.props.auth.user.role === 'patient'
                                 }">
                                <i class="fas fa-user-shield" v-if="$page.props.auth.user.role === 'admin'"></i>
                                <i class="fas fa-user-md" v-if="$page.props.auth.user.role === 'doctor'"></i>
                                <i class="fas fa-user" v-if="$page.props.auth.user.role === 'patient'"></i>
                                {{ $page.props.auth.user.role === 'admin' ? 'Admin' : $page.props.auth.user.role === 'doctor' ? 'Médico' : 'Paciente' }}
                            </div>
                            ...
                            <form @submit.prevent="logout">
                                <button 
                                    type="submit"
                                    class="group flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-red-600 border border-gray-300 rounded-lg hover:border-red-300 hover:bg-red-50 transition-all duration-200"
                                    title="Cerrar sesión"
                                >
